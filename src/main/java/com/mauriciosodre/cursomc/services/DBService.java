...
import com.mauriciosodre.cursomc.domain.ItemPedido;
...
import com.mauriciosodre.cursomc.repositories.ItemPedidoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		// Instanciando produtos para testar infinity scroll
		...
		// Incluindo os produtos de teste de infinity scroll na cat1
		cat1.getProdutos()
		...
		// Incluindo as categorias nos produtos de teste de infinity scroll
		...
		// Persistindo os produtos de teste de infinity scroll
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "m.sodre8@gmail.com", "36378912377", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
		Cliente cli2 = new Cliente(null, "Mauricio Junior", "mss.junior@globo.com", "80784787123",
				TipoCliente.PESSOAFISICA, pe.encode("8877"));

		// Adicionando outro perfil ao cliente
		cli2.addPerfil(Perfil.ADMIN);

		// Incluindo os telefones
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cli1.getTelefones().addAll(Arrays.asList("32125634", "96882188"));

		// Instanciando e testando os endereços
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Rua do Matoso", "530", null, "Centro", "22775051", cli2, c2);
